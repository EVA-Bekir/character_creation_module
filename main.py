...
def attack(char_name: str, char_class: str) -> str:
    """Это начало описания этой функции."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает метод defence и демонстрирует перенос строки
        документации.
        """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает метод special и демонстрирует перенос строки
        документации.
        """
    if char_class == 'warrior':
        return (f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает метод start_training и демонстрирует перенос строки
        документации.
        """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывает метод choice_char_class и демонстрирует перенос строки
        документации.
        """
    approve_choice = None
    char_class = None
